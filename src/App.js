      ...
      <div className="App">
        ...
        <header className="App-header">
          ...
          <div className="icons">
            ...
            <a href="https://drive.google.com/file/d/1Aw2fSE_CwIRppPtpJ1WhZm9UI0aZUJPQ/view?usp=sharing">
        ...
        <div className='about' id="about">
         ...
         <div className='about-me'>
            <p className='about-p'>
              ...
              I enjoy working with teams and I am always looking to explore new technologies. I relish scrum type management and utilizing git workflows to meet deadlines ahead of schedule or on time.<br/>
